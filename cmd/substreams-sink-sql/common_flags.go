...
func newDBLoader(
	...
	dbLoader, err := db.NewLoader(psqlDSN, batchBlockFlushInterval, batchRowFlushInterval, liveBlockFlushInterval, moduleMismatchMode, &handleReorgs, sinkRange, zlog, tracer)
	if err != nil {
