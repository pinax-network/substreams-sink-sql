...
func sinkRunE(cmd *cobra.Command, args []string) error {
	...
	dbLoader, err := newDBLoader(cmd, dsn, batchBlockFlushInterval, sflags.MustGetInt(cmd, "batch-row-flush-interval"), sflags.MustGetInt(cmd, "live-block-flush-interval"), handleReorgs, sink.BlockRange())
	if err != nil {
